...
#define VS_SUBVERSION   120  /* 3.7.8  high four bits are subversion, and lower four bits are release version */

                            /*
                               3.7.8
                                      1. Add script function 'setShareLibraryPath'
                                      2. add function for ClassOfSRPParaPackageInterface : 'Copy'
                            */
...
/*-----*/
  ...
  /*v3.0.0, support descript cle object : {"cleobject":"ID"} */
	...
	/*--v3.7.8--*/
	virtual VS_BOOL SRPAPI Copy(VS_INT32 Index,class ClassOfSRPParaPackageInterface *ParaPkg_Src,VS_INT32 Index_Src) = 0;
};
#endif
